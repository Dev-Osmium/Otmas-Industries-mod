/*
 * Copyright (c) 2016. This program is licensed under GPL 3.0 ShareAlike Attribution. No version of this program may be sold or given away without attributing the work to the original creator, Otmas.
 */
...
public class ExampleMod
{
    ...
    public void init(FMLInitializationEvent event)
    {
        ...
        // Crafting Recipes
        System.out.println("Loading Craftting Recipes");
        //Shaped Recipes
